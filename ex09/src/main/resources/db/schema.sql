...
CREATE TABLE chess_fair (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
   CONSTRAINT pk_chess_fair PRIMARY KEY (id)
);
...
ALTER TABLE position_in_chess_fair ADD CONSTRAINT FK_POSITION_IN_CHESS_FAIR_ON_CHESS_FAIR FOREIGN KEY (chess_fair_id) REFERENCES chess_fair (id);
